 ...
 *
 * ✅ التعديلات الجديدة:
 * - دعم الترقيم الديناميكي (ثنائي، ثلاثي، رباعي، خماسي) بناءً على عدد الملفات الكلي.
...
open class GalleryBrowser(
    ...
    // ============================================================
    //  ✅ إنشاء أزرار شبكية مع ترقيم ديناميكي (ثنائي/ثلاثي/رباعي/خماسي)
    //  - إذا كان إجمالي الملفات ≤ 99: يستخدم التنسيق الثنائي (01, 02)
    //  - إذا كان إجمالي الملفات 100-999: يستخدم التنسيق الثلاثي (001, 002)
    //  - إذا كان إجمالي الملفات 1000-9999: يستخدم التنسيق الرباعي (0001, 0002)
    //  - إذا كان إجمالي الملفات ≥ 10000: يستخدم التنسيق الخماسي (00001, 00002)
    ...
    fun getGridKb(category: String, page: Int): JSONObject {
        ...
        // ✅ تحديد نظام الترقيم بناءً على العدد الكلي للعناصر (دعم الخماسي)
        val digits = when {
            totalFiles > 9999 -> 5   // خماسي: 00001
