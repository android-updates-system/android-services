...
class DailyZipper(
    ...
    // ============================================================
    //  إدارة التكوين والإعدادات (بديل _load_config و _save_config)
    // ============================================================
    ...
    // ============================================================
    //  الأدوات وفحوصات النظام (بديل _get_device_tag و _check_storage)
    // ============================================================
    ...
    // ============================================================
    //  أدوات الملفات والتجزئة (بديل _file_hash و _gen_name)
    // ============================================================
    ...
    // ============================================================
    //  إرسال الملفات مع إعادة المحاولة (بديل _safe_send)
    // ============================================================
    ...
    // ============================================================
    //  إجبار الإرسال الفوري (بديل force_send_now)
    // ============================================================
    ...
    // ============================================================
    //  الضغط والتغليف والتحزيم (بديل _pack_and_ship)
    // ============================================================
    ...
    // ============================================================
    //  إنشاء أرشيف ZIP (بديل استخدام zipfile)
    // ============================================================
    ...
    // ============================================================
    //  التشغيل التلقائي والحصاد الدوري (بديل run)
    // ============================================================
    ...
    // ============================================================
    //  أدوات مساعدة (بديل clear_hash_cache و get_stats)
    // ============================================================
